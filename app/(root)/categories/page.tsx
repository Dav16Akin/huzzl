...
const page = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="border w-full justify-between gap-4 px-8 py-2 flex items-center">
        {/* searchbar */}
        <Search />
        <Input
          value={searchTerm}
      ...
      <div className="flex gap-4 p-4">
        {categories.map((category, index) => (
          <Badge
          variant="outline"
            className={`cursor-pointer ${selectedCategory === category ? "bg-primary text-white" : ""} p-2 rounded-md`}
